...
void ip_send_packet(char *packet, int len)
{
	...
	// printf("debug: in the front of ip send packet.\n");
	...
	// printf("debug: before iface_send_packet_by_arp in ip_send_packet.\n");
	// printf("debug: packet addr:%p.\n", packet);
	iface_send_packet_by_arp(iface, next_hop, packet, len);
	// printf("debug: after  iface_send_packet_by_arp in ip_send_packet.\n");
