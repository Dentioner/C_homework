...
public:
  ...
  /// lab1 added
  bool elementWiseON; // True when \#pragma elementWise on
...
public:
  ...
  enum PragmaElementWiseKind {
    PEW_OFF, // #pragma elementWise off
    PEW_ON   // #pragma elementWise on
  };
  ...
  /// lab1 added
  /// ActOnPragmaElementWise - Called on well formed \#pragma elementWise [on|off].
  ...
  AssignConvertType CheckSingleAssignmentConstraints_lab2_version(QualType LHSType,
