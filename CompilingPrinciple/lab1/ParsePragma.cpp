...
void Parser::HandlePragmaElementWise() // lab1 added
{
                                            ...
                                            Token &ElementWiseTok)
{
  ...
  Sema::PragmaElementWiseKind Kind = Sema::PEW_OFF; // Kind的默认值为OFF，也就是不加修饰的时候
  ...
  Kind = Sema::PEW_ON; // 到了这里说明加了合法的elementWise，把kind调整为ON
